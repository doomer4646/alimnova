...
public class Wiskey extends JFrame {
	...
	private void initComponents() {
		...
		add(getJLabelInfoPropiedad(), new Constraints(new Leading(182, 132, 10, 10), new Leading(29, 220, 10, 10)));
	...
	private JLabel getJLabelInfoPropiedad() {
	...
	private void jLabel22MouseMouseEntered(MouseEvent event) {
		jLabelInfoPropiedad.setIcon(new ImageIcon("PROPIEDADES/5A.png"));
	}

	private void jLabel23MouseMouseEntered(MouseEvent event) {
		jLabelInfoPropiedad.setIcon(new ImageIcon("PROPIEDADES/15A.png"));
	}

	private void jLabel24MouseMouseEntered(MouseEvent event) {
		jLabelInfoPropiedad.setIcon(new ImageIcon("PROPIEDADES/25A.png"));
	}

	private void jLabel25MouseMouseEntered(MouseEvent event) {
		jLabelInfoPropiedad.setIcon(new ImageIcon("PROPIEDADES/35A.png"));
	}

	private void jLabel26MouseMouseEntered(MouseEvent event) {
		jLabelInfoPropiedad.setIcon(new ImageIcon("PROPIEDADES/12A.png"));
	}

	private void jLabel27MouseMouseEntered(MouseEvent event) {
		jLabelInfoPropiedad.setIcon(new ImageIcon("PROPIEDADES/28A.png"));
	}
