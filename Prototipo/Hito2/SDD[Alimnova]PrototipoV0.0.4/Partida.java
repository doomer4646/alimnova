 ...
 * @author hp
 * @version 1.0
 * @created 05-may-2010 04:56:11 p.m.
 */
public class Partida implements Comunicacion {
	 ...
	 */
	public void actualizarNegociacion(ArrayList propiedadesDemandado, ArrayList propiedadesDemandante, int dineroDemandado, int dineroDemandante){
	 ...
	 * @param idJugador1
	 */
	public boolean solicitudNegocio(ArrayList propiedadesJ2, ArrayList propiedadesJ1, int dineroJ2, int dineroJ1, int idJugador2, int idJugador1){
		return false;
	}
